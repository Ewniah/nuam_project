...
class Rol(models.Model):
    """Define roles de usuario para RBAC (Administrador, Analista, Auditor)"""
...
class PerfilUsuario(models.Model):
    """Extiende User de Django con información adicional y rol asignado"""
...
class InstrumentoFinanciero(models.Model):
    """Catálogo de instrumentos financieros (acciones, bonos, fondos, etc.)"""
