...
urlpatterns = [
    ...
    path('carga-masiva/plantilla/xlsx/', views.descargar_plantilla, {'formato': 'xlsx'}, name='descargar_plantilla'),
    path('carga-masiva/plantilla/csv/', views.descargar_plantilla, {'formato': 'csv'}, name='descargar_plantilla_csv'),
